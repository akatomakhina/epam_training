...
import by.epamTrainings.task3dot4.entity.interfaces.Queue;
import by.epamTrainings.task3dot4.exception.InvalidIndexExceptions;
...
public class LinkedList<E> implements List<E>, Queue<E> {
    ...
    public void remove(int index) {
        ...
        else throw new InvalidIndexExceptions("Index: " + index + ", Size: " + size);
    }
