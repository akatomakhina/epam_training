    ...
    <div class="container">
      <div class="registration">
        ...
        <div class="registration__form">
          <input type="text" name="login" class="registration__input" name="name" placeholder="Имя"><br>
          <input type="text" name="login" class="registration__input" name="surname" placeholder="Фамилия"><br>
